...
cat second_gaussian/no_def_0_4.txt | grep 'PH Level'| awk '{print $4}' > second_gaussian/ph_no_def_0_0_4.txt
cat second_gaussian/no_def_0_4.txt | grep 'Tank 1'| awk '{print $6}' > second_gaussian/tank_1_no_def_0_0_4.txt
cat second_gaussian/no_def_0_4.txt | grep 'Tank 2'| awk '{print $6}' > second_gaussian/tank_2_no_def_0_0_4.txt
