...
def francisco_model(l,q,t):
  ...
  f = [L1,
      Q1 - u13*sn*sign(L1-L3)*math.sqrt(2*g*(L1-L3))
      L2,
      Q2 + u32*sn*sign(L3-.L2)*math.sqrt(abs(2*g*(.L3-.L2)))  - u20*sn*math.sqrt(2*g*L2)
      L3,
      u13*sn*sign(L1-L3)*math.sqrt(2*g*(L1-L3)) - u32*sn*sign(L3-self.L2)*math.sqrt(abs(2*g*(L3-L2)))
      ]
...
wsol = odeint(francisco_model, l0, t, args=(q,))
