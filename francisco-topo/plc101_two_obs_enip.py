...
class Lit101EnipSocket(Thread):
    ...
    def run(self):
        ...
        while (self.plc.count <= PLC_SAMPLES):
            try:
	        self.plc.received_lit101 = float(Decimal(self.plc.receive(LIT101, SENSOR_ADDR)))
		print self.plc.received_lit101
...
class PLC101(PLC):
    ...
    def main_loop(self):
        ...
        """
        lit101socket = Lit101EnipSocket(self)
        lit101socket.start()
