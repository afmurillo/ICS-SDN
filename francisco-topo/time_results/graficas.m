...
reference_value_2(1:70)=0.20; reference_value_2(71:400)=0.225; reference_value_2(401:501)=0.20;
...
ruio_no_attack = csvread('no_attack_socket/matlab_ruio.txt');
ruio_no_def    = csvread('attack_no_def_socket/matlab_ruio.txt');
ruio_def    = csvread('atk_def_socket/matlab_ruio.txt');
...
% print(h1,'std_no_attack.pdf','-dpdf','-r0')
...
% print(h2,'std_diff_no_def.pdf','-dpdf','-r0')
...
% print(h3,'std_diff_def.pdf','-dpdf','-r0')
...
% print(h15,'std_mean_error_def.pdf','-dpdf','-r0')



h16=figure(16)
set(gca, 'FontSize', fsz, 'LineWidth', 1.5); 
plot(ruio_no_attack,'-.r', 'linewidth', 1.5);
hold on
% plot(error_vector, abs(mean_error_def), '-b', 'linewidth', 1.5);
% plot(error_vector, abs(mean_lit_101_error_no_atk), '--k', 'linewidth', 1.5);

g = legend('Residue without Attack');
g.FontSize = 14;
grid on
%axis([0 420 -5.5e-3 1e-3])
axis([0 420 -5.5e-3 12e-3])
grid on;
xlabel('Time (s)')
ylabel('Tank Level (m)')
%title({'   Plant Mean Error with Bias Attack'});
matlab2tikz('tikz/std_ruio_no_attack.tikz', 'showInfo', false, 'parseStrings', false, 'standalone', true, 'height','0.5\columnwidth', 'width', '0.8\columnwidth');
print(h16,'std_ruio_no_attack.pdf','-dpdf','-r0')


h17=figure(17)
set(gca, 'FontSize', fsz, 'LineWidth', 1.5); 
plot(ruio_no_def,'-.r', 'linewidth', 1.5);
hold on
% plot(error_vector, abs(mean_error_def), '-b', 'linewidth', 1.5);
% plot(error_vector, abs(mean_lit_101_error_no_atk), '--k', 'linewidth', 1.5);

g = legend('Residue without Defense');
g.FontSize = 14;
grid on
axis([0 420 -5.5e-3 12e-3])
grid on;
...
ylabel('Tank Level (m)')
%title({'   Plant Mean Error with Bias Attack'});
matlab2tikz('tikz/std_ruio_no_def.tikz', 'showInfo', false, 'parseStrings', false, 'standalone', true, 'height','0.5\columnwidth', 'width', '0.8\columnwidth');
print(h17,'std_ruio_no_def.pdf','-dpdf','-r0')
